<?php /*a:1:{s:59:"D:\wamp64\www\sweet\application\view\front\index\index.html";i:1593258847;}*/ ?>
﻿<!doctype html>
...
<head>
  ...
  <!-- all css here -->
  <link rel="stylesheet" href="/sweet/public/front/css/bootstrap.min.css">
  <link rel="stylesheet" href="/sweet/public/front/css/icons.css">
  <link rel="stylesheet" href="/sweet/public/front/css/plugins.css">
  <link rel="stylesheet" href="/sweet/public/front/css/style.css">
  <link rel="stylesheet" href="/sweet/public/front/css/responsive.css">
  <script src="__JS__/vendor/modernizr-2.8.3.min.js"></script>
</head>
<body>
<!-- header start -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-4 col-5 col-sm-4">
        <div class="logo">
          <a href="index.html">
            <img class="logo-normal" alt="" src="/sweet/public/front/images/indeximg/logo/logo.png">
            <img class="logo-sticky" alt="" src="/sweet/public/front/images/indeximg/logo/logo-black.png">
          </a>
        </div>
      </div>
          ...
          <div class="main-menu">
            <nav>
              <ul>
                ...
                <li><a href="about-us.html">兑换商品</a></li>
...
<div class="slider-area">
  <div class="slider-active owl-dot-style owl-carousel">
    <div class="single-slider bg-img height-100vh d-flex align-items-center justify-content-center" style="background-image:url(/sweet/public/front/images/indeximg/slider/slider-1.jpg);">
    ...
    <div class="single-slider bg-img height-100vh d-flex align-items-center justify-content-center" style="background-image:url(/sweet/public/front/images/indeximg/slider/slider-2.jpg);">
      <div class="slider-content pt-100">
        <div class="slider-content-wrap slider-animated-1">
          <h2 class="animated">Welcome to <span>Basmoti</span> Restaurant</h2>
  ...
  <div class="container">
    ...
    <div class="product-slider-active owl-carousel">
      <div class="product-style-wrap">
        <img alt="" src="/sweet/public/front/images/indeximg/product/pro-1.jpg">
      ...
      <div class="product-style-wrap">
        <img alt="" src="/sweet/public/front/images/indeximg/product/pro-2.jpg">
        <div class="product-content text-center">
          <h4>
            Black Bean Fajitas
          </h4>
      ...
      <div class="product-style-wrap">
        <img alt="" src="/sweet/public/front/images/indeximg/product/pro-3.jpg">
        <div class="product-content text-center">
          <h4>
            Chicken Nugget
          </h4>
      ...
      <div class="product-style-wrap">
        <img alt="" src="/sweet/public/front/images/indeximg/product/pro-4.jpg">
        <div class="product-content text-center">
          <h4>
            Match Fajita Trio
          </h4>
      ...
      <div id="tab1" class="tab-pane active">
        <div class="row">
          <div class="col-lg-6">
            <div class="single-menu-product mb-30">
              <div class="menu-product-img">
                <img alt="" src="/sweet/public/front/images/indeximg/product/menu-1.jpg">
              </div>
          ...
          <div class="col-lg-6">
            <div class="single-menu-product mb-30">
              <div class="menu-product-img">
                <img alt="" src="/sweet/public/front/images/indeximg/product/menu-2.jpg">
              </div>
              <div class="menu-product-content">
                <div class="menu-title-price">
                  <div class="menu-title">
          ...
          <div class="col-lg-6">
            <div class="single-menu-product mb-30">
              <div class="menu-product-img">
                <img alt="" src="/sweet/public/front/images/indeximg/product/menu-3.jpg">
              </div>
              <div class="menu-product-content">
                <div class="menu-title-price">
                  <div class="menu-title">
          ...
          <div class="col-lg-6">
            <div class="single-menu-product mb-30">
              <div class="menu-product-img">
                <img alt="" src="/sweet/public/front/images/indeximg/product/menu-4.jpg">
              </div>
              <div class="menu-product-content">
                <div class="menu-title-price">
                  <div class="menu-title">
          ...
          <div class="col-lg-6">
            <div class="single-menu-product mb-30">
              <div class="menu-product-img">
                <img alt="" src="/sweet/public/front/images/indeximg/product/menu-5.jpg">
              </div>
              <div class="menu-product-content">
                <div class="menu-title-price">
                  <div class="menu-title">
          ...
          <div class="col-lg-6">
            <div class="single-menu-product mb-30">
              <div class="menu-product-img">
                <img alt="" src="/sweet/public/front/images/indeximg/product/menu-6.jpg">
              </div>
              <div class="menu-product-content">
                <div class="menu-title-price">
                  <div class="menu-title">
...
<!-- all js here -->
<script src="/sweet/public/front/js/vendor/jquery-1.12.0.min.js"></script>
<script src="/sweet/public/front/js/popper.js"></script>
<script src="/sweet/public/front/js/bootstrap.min.js"></script>
<script src="/sweet/public/front/js/ajax-mail.js"></script>
<script src="/sweet/public/front/js/plugins.js"></script>
<script src="/sweet/public/front/js/main.js"></script>
</body>
</html>