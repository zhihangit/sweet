<?php /*a:2:{s:61:"D:\wamp64\www\sweet\application\view\back\home\addvender.html";i:1594048851;s:52:"D:\wamp64\www\sweet\application\view\backlayout.html";i:1594483611;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">商家进驻</div>
                <div class="panel-body" style="min-height: 214px;">
                    <form class="form-horizontal"  enctype="multipart/form-data" action="<?php echo url('back.home/doaddvender'); ?>" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="userpwd" type="password" class="form-control" id="user_pwd" placeholder="密码">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="limite" id="limiteRadio3" value="3"> 3门店管理员
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="company" class="form-control" id="company" placeholder="商家名称">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email"  name="email" class="form-control" id="areaid" placeholder="email">
                            </div>
                        </div>
